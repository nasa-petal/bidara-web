...
<div class="section-footer {classes}" class:pin-footer={pin}>
  ...
  <div class="content has-text-centered credit-footer">
    <p>
      <strong>BIDARA</strong>
      <span class="author">by
      <a target="_blank" href="https://www1.grc.nasa.gov/research-and-engineering/vine/petal/">PeTaL</a>
      </span>
      <a target="_blank" class="ml-4" href="https://github.com/nasa-petal/bidara-web"><span style="position:absolute" class="icon default-text"><Fa size="2x" icon="{faGithub}"/></span></a>
